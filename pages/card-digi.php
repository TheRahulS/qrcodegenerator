                    ...
                    <ul class="nav-gen">
                        <li>
                            <a href="card-digi.php" class="active">
                                ...
                                <div class="nav_text" style="overflow: hidden;white-space:nowrap;max-width:180px;text-overflow: ellipsis;">
        ...
        <div class="form-group form-control b-0 sh">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12 p-1 sh">
                    <form class="form-group form-text g-3" action="../config/upload.php" method="post" enctype="multipart/form-data" data-parsley-validate data-parsley-errors-messages-enabled>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-12 p-1">
                                                    <div class="mb-2">
                                                        <h6 class="t-d">Profile Photo: <small class="text-danger">(.jpeg,.jpg,.png)*</small> <br>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12 p-1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-12 p-1">
                                                            ...
                                                            <input type="file" name="Logo" id="logoImageInput" accept=" .png" onchange="previewLogoImage()" required data-parsley-fileextension="png" />
                                                        </div>
                                                        <!-- <div class="col-lg-12 col-md-12 col-12 p-1">
                                                            <div class="image-container">
                                            ...
                                            <div class="row p-4 align-items-center">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-12 p-1">
                                                        <label class=" text-muted" for="name">Name:<small class="text-danger">*</small></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-12 p-1 ">
                                                        ...
                                                        <input type="text" id="designation" onkeyup="updatedesignation()" class="form-control" name="Designation" placeholder="Enter Designation/Position" required>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12 p-1 ">
                                                        <small class="text-muted">Company:<small class="text-danger">*</small></small>
                                                        <input type="text" id="company" onkeyup="updatecompany()" class="form-control" name="CompanyName" placeholder="Enter Company Name" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-12 p-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-lg-8 col-md-8 col-12 p-1">
                                                                ...
                                                                <input type="email" id="emailInput" class="form-control" name="emailicon" placeholder="email@domain.com" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-12 p-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-lg-8 col-md-8 col-12 p-1">
                                                                ...
                                                                <input type="tel" id="phoneInput" class="form-group form-control" name="callicon" placeholder="(+91) phone number" pattern="^[6-9]\d{9}$" minlength="10" maxlength="10" required data-parsley-error-message="Please enter a valid mobile number." data-parsley-trigger="keyup" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-12 p-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-lg-8 col-md-8 col-12 p-1">
                                                                <small class="text-muted">Whatsapp:<small class="text-danger">*</small></small>
                                                                <input type="tel" class="form-group form-control" name="messageicon" id="message-no" placeholder="(+91) phone number " pattern="^[6-9]\d{9}$" minlength="10" maxlength="10" required data-parsley-error-message="Please enter a valid mobile number." data-parsley-trigger="keyup" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-11 col-md-11 col-12 p-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-lg-8 col-md-8 col-12 p-1">
                                                                ...
                                                                <input type="email" id="emailaddress" onkeyup="emailpreview()" class="form-control" name="Email" placeholder="email@domain.com" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-11 col-md-11 col-12 p-1">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-lg-8 col-md-8 col-12 p-1">
                                                                ...
                                                                <input type="tel" class="form-group form-control" name="phone" id="mobilephone" onkeyup="mobilepreview()" placeholder="(+91) phone number " pattern="^[6-9]\d{9}$" minlength="10" maxlength="10" required data-parsley-error-message="Please enter a valid mobile number." data-parsley-trigger="keyup" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10 col-md-10 col-12 p-1">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Address Line 1<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-control" id="street-1" name="Address1" onkeyup="updateAddress()" placeholder="Enter Address" required>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Address Line 2<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-control" id="street-2" name="Address2" onkeyup="updateAddress()" placeholder="Enter Address" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Country<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-control" id="country" name="country" onkeyup="updateAddress()" placeholder="Enter Country" required>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">State<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-control" id="state" name="state" onkeyup="updateAddress()" placeholder="Enter State" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">City<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-control" id="city" name="city" onkeyup="updateAddress()" placeholder="Enter City" required>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Zip Code<small class="text-danger">*</small></small>
                                                                <input type="text" class="form-group form-control" id="zip-code" name="zip" placeholder="Enter PIN code" data-parsley-zip-code="true" minlength="6" maxlength="6" required data-parsley-error-message="Please enter a valid Indian ZIP code." data-parsley-trigger="keyup" />
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Action Button <i class="fa-regular fa-compass"></i><small class="text-danger">*</small></small>
                                                                <input type="text" id="action" onkeyup="actionpreview()" class="form-control" value="Get Direction" name="action" placeholder="Text" disabled maxlength="13">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12 p-1">
                                                                <small class="text-muted">Google Map URL<small class="text-danger">*</small></small>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12 p-1">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-12 p-1">
                                                            ...
                                                            <input type="text" class="form-control" name="URL" id="web-link-input" value="http://www.delta.co" required data-parsley-type-message="Please enter a valid URL">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-12 p-1">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="websitelink" onkeyup="preview()" placeholder="web title" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-12 p-1">
                                                                <div class="row">
                                                                    <div class="col-lg-2 col-md-2 col-12 p-1">
                                                                        <i class="fa fa-linkedin-square" style="font-size:2.5rem;"></i>
                                                                    </div>
                                                                    <div class="col-lg-10 col-md-10 col-12 p-1">
                                                                        <input type="text" class="form-control" name="linkedin" id="linkedinInput" placeholder=" usernameLinkedin">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-12 p-1">
                                                                <div class="row">
                                                                    <div class="col-lg-2 col-md-2 col-12 p-1">
                                                                        <i class="fa fa-instagram" style="font-size:2.5rem;"></i>
                                                                    </div>
                                                                    <div class="col-lg-10 col-md-10 col-12 p-1">
                                                                        <input type="text" id="instagramInput" class="form-control" name="instagram" placeholder="username-instagram">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-12 p-1">
                                                                <div class="row">
                                                                    <div class="col-lg-2 col-md-2 col-12 p-1">
                                                                        <i class="fa fa-twitter" style="font-size:2.5rem;"></i>
                                                                    </div>
                                                                    <div class="col-lg-10 col-md-10 col-12 p-1">
                                                                        <input type="text" id="twitterInput" class="form-control" name="twitter" placeholder="username-twitter">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-12 p-1">
                                                                <div class="row">
                                                                    <div class="col-lg-2 col-md-2 col-12 p-1">
                                                                        <i class="fa fa-facebook" style="font-size:2.5rem;"></i>
                                                                    </div>
                                                                    <div class="col-lg-10 col-md-10 col-12 p-1">
                                                                        <input type="text" class="form-control" name="facebook" id="facebookInput" placeholder="username-facebook">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="upload-container">
                                                        <div class="border-container">
                                                            ...
                                                            <p>
                                                                ...
                                                                <input type="file" name="imagepost" id="file-post" accept=".jpeg, .jpg, .png"  required data-parsley-fileextension="jpeg,jpg,png" data-parsley-trigger="change" data-parsley-errors-container="#filePostErrorContainer" data-parsley-max-file-size="5000" data-parsley-error-message="This file should not be larger than 5MB." data-parsley-max-file-size-message="This file should not be larger than %s mb." />
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="device-i">
                            <div class="status-i">
                                ...
                                <div class="icons-i">
                                    <iconify-icon icon="ic:round-signal-cellular-alt" inline style="font-size:2rem;"></iconify-icon>
                            ...
                            <div id="preview">
                                <div class="">
                                    ...
                                    <div class="card-1 card-1-p" style=" background-image: url('../images/profile.jpg');  background-size: cover;    background-repeat: no-repeat;    max-width:400px;    ">
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-12 ">
                                                        <div class="logo-container">
                                                            <img src="" class="logo" id="image-banner" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-1 ">
                                        ...
                                        <div class="card-footer b-t text-center">
                                            <div class="row  justify-content-center">
                                                <div class="col-lg-4 col-12 p-1 mb-2"><a href="#" id="callLink" class="btn round-circle contact-link">
                                                        <iconify-icon icon="material-symbols:call" inline style="font-size:2rem;"></iconify-icon>
                                                    </a>
                                                </div>
                                                <div class="col-lg-4 col-12 p-1 mb-2"><a href="#" id="emailLink" class="btn round-circle contact-link">
                                                        <iconify-icon icon="material-symbols:mail-outline" inline style="font-size:2rem;"></iconify-icon>

                                                    </a></div>
                                                <div class="col-lg-4 col-12 p-1"><a href="#" id="open-whatsapp" class="btn round-circle contact-link">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-c ">
                                                <button class="btn btn-b ">
                                                    <a href="https://maps.app.goo.gl/414ux42d2Bgp83vb9" id="map-link" class="btn d-flex " target="_blank">
                                                        <iconify-icon icon="entypo:direction" inline style="font-size:2.5em;"></iconify-icon>&nbsp;<b>
                                    ...
                                    <div class="card-1">
                                        <div class="card-header-3">
                                            <div class="card-header-4">
                                                <div class="col-3 text-center">
                                                    <iconify-icon icon="fluent-mdl2:website" inline style="font-size:2rem;"></iconify-icon>
                                                </div>
                                                <div class="col-9 text-start">
                                                    <h4>&nbsp; Website</h4>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-text">
                                                <a href="https://www.website.in/" class="contact-link" id="dynamic-link" target="_blank">
                                                    <h5 id="previewplaceholder">
                                                        <iconify-icon icon="mdi:search-web" inline style="font-size:2rem;"></iconify-icon>
                                                        &nbsp;Website
                                                    </h5>
                                                </a>
                                            </h4>
                                            <a href="#" id="linkedinLink" class="btn btn-error contact-link rounded-circle" target="_blank">
                                                <iconify-icon icon="ri:linkedin-line" inline style="font-size:2rem;"></iconify-icon>
                                            </a>

                                            <a href="https://www.instagram.com/deltaview.in/" id="instagramLink" class="btn btn-error contact-link rounded-circle" target="_blank"><iconify-icon icon="line-md:instagram" inline style="font-size:2rem;"></iconify-icon>
                                            </a>
                                            <a href="https://www.facebook.com/DeltaITNetwork/" id="facebookLink" class="btn btn-error contact-link rounded-circle" target="_blank">
                                                <iconify-icon icon="streamline:computer-logo-facebook-2-media-facebook-social" inline style="font-size:2rem;"></iconify-icon>
                                            </a>
                                            <a href="https://www.twitter.com/DeltaITNetwork/" id="twitterLink" class="btn btn-error contact-link rounded-circle" target="_blank">
                                                <iconify-icon icon="streamline:computer-logo-twitter-media-twitter-social" inline style="font-size:2rem;"></iconify-icon>
                                            </a>
